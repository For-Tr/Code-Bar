...
import type { ConflictFilePayload, ScmStatusGroups } from "@codebar/contracts";
import { type DiffFile } from "./sessionStore";

export type { ConflictFilePayload, ScmStatusEntry, ScmStatusGroups } from "@codebar/contracts";
...
interface ScmStore {
  ...
  conflictBySessionId: Record<string, ConflictFilePayload | null>;
  ...
  setConflictPayload: (sessionId: string, payload: ConflictFilePayload | null) => void;
}
